...
* **UI Layout (Single Pane View เน้นเนื้อหา):**
    ...
    * **พื้นที่เนื้อหา (Content Area):**
        ...
        * (โหมดแปล) การโต้ตอบกับเส้นมาร์ค (MarkLine Interaction):
            * **คลิก (Click):** มาร์ค/ยกเลิกมาร์คบรรทัด (เปลี่ยนสีพื้นหลังบรรทัดเป็นสีทองอ่อนๆ หรือมีสัญลักษณ์ติ๊กถูกสีทอง) -> บันทึกใน `mark_lines.marked_lines_data` ให้แน่ใจว่าใน database มีแบ่ง ชื่อนักแปล ชื่อนิยาย ชื่อตอน เลขตอน และ mark_linse
